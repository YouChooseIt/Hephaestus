...
public abstract class Entity {
    ...
    public void applyEntityCollision(Entity entity) {
        final PushOutOfEntityEvent pushOutOfEntityEvent = new PushOutOfEntityEvent();
        Hephaestus.getInstance().getEventBus().post(pushOutOfEntityEvent);

        if (pushOutOfEntityEvent.isCancelled()) {
            return;
        }
