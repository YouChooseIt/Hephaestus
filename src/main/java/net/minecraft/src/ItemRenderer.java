...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float f) {
        ...
        GL11.glPopMatrix();
        ItemStack itemstack = Hephaestus.getInstance().getModuleManager().getRegistry().get(Slot9Module.class).isEnabled() ? mc.thePlayer.inventory.getStackInSlot(9) : itemToRender;
        ...
        if (Hephaestus.getInstance().getModuleManager().getRegistry().get(ViewModelModule.class).isEnabled()) {
            GL11.glTranslatef(ViewModelModule.xOffset.getValue().floatValue(), 0.0f, 0.0f);
            GL11.glTranslatef(0.0f, ViewModelModule.yOffset.getValue().floatValue(), 0.0f);
            GL11.glTranslatef(0.0f, 0.0f, ViewModelModule.zOffset.getValue().floatValue());
        }
